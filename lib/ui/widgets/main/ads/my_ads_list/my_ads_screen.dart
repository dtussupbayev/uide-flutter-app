...
class _MyAdsScreenState extends State<MyAdsScreen>
  ...
  Widget build(BuildContext context) {
    if (kIsWeb || Platform.isMacOS || Platform.isLinux || Platform.isWindows) {
      return WillPopScope(
          onWillPop: _onBackPressed, child: _DesktopLayout(widget: widget));
    }
    return WillPopScope(
        onWillPop: _onBackPressed, child: _MobileLayout(widget: widget));
  }
}
