...
class RoommateDetailsScreen extends StatefulWidget {
  ...
  const RoommateDetailsScreen(
      {super.key, required this.roommateId, required this.pageIndex});
            ...
            child: LikeButton(
              ...
              onTap: (isTapped) async {
                if (model.isSaved == true) {
                  model.deleteFromSaved(widget.roommateId ?? 'dasda', context);
                } else {
                  model.addToSaved(widget.roommateId ?? 'dasd', context);
                }
                return !isTapped;
              },
            ),
...
class _MobileLayout extends StatelessWidget {
  const _MobileLayout({
    super.key,
    required this.model,
    required this.roommateDetails,
    required this.widget,
  });

  final RoommateDetailsModel? model;
  final HouseDetailsResponse? roommateDetails;
  final RoommateDetailsScreen widget;
    ...
    return Column(
      children: [
        Flexible(
          ...
          child: Stack(
            children: [
              RoommateDetailsImageWidget(model: model, roommateDetails: roommateDetails),
              Padding(
            ...
            child: Column(
              ...
              children: [
                SizedBox(
                  ...
                  child: Stack(
                    children: [
                      DesktopRoommateDetailsImageWidget(
                          model: model, roommateDetails: roommateDetails),
                      Padding(
                        padding: const EdgeInsets.only(
                          left: 20,
                          top: 10,
                ...
                const DesktopRoommateDetailsContent(),
              ],
            ),
          ),
        ),
...
class RoommateDetailsImageWidget extends StatelessWidget {
  const RoommateDetailsImageWidget({
    super.key,
    required this.model,
    required this.roommateDetails,
  });
  ...
  Widget build(BuildContext context) {
    return FadeInImage.memoryNetwork(
      ...
      image: model!.loadImageUrl(roommateDetails!.photos),
...
class DesktopRoommateDetailsImageWidget extends StatelessWidget {
  const DesktopRoommateDetailsImageWidget({
    super.key,
    required this.model,
    required this.roommateDetails,
  });
